            ...
            <div class="col-md-4 offset-md-4" style="margin-top: 45px">
                ...
                <form action="{{ route('user.create') }}" method="Post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="eamil" class="form-control" id="email" aria-describedby="emailHelp" value="{{old('email')}}">
                    ...
                    <div class="form-group">
                        ...
                        <small id="cpasswordHelp" class="form-text text-muted">We'll never share your password with anyone else.</small>
                        <br>
                        <span class="text-danger">
                            @error('cpassword')
                                {{$message}}                                
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{route('user.login')}}">i am alredy login</a>
                    </div>
                </form>
            </div>
        </div>
